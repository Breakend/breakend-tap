class Pspp < Formula
  desc "Statistical analysis of sampled data (FOSS SPSS clone), originally from https://raw.githubusercontent.com/brewsci/homebrew-science/master/Formula/pspp.rb"
